...
import MenuButton from './MainButton.js';
    ...
    _renderRow(rowData) {
        return (
            <View style={{flexDirection: 'row'}}>
                ...
                <TouchableWithoutFeedback style={{flex: 1, alignItems: 'center'}}
                                          onPress={() => {
                                              this._onRecommendClick(rowData.right.wareId)
                                          }}>
                    <View style={{flex: 1, alignItems: 'center'}}>
                    ...
                    return (
                        <View>
                            ...
                            <View style={styles.menuView}>
                                <MenuButton buttonIcon={require('../images/home_icons/wdgz.png')}
                                            buttonTitle={'我的关注'} tag={'wdgz'}
                                            onClick={this._onMenuClick}/>
                                <MenuButton buttonIcon={require('../images/home_icons/wlcx.png')}
                                            buttonTitle={'物流查询'} tag={'wlcx'}
                                            onClick={this._onMenuClick}/>
                                <MenuButton buttonIcon={require('../images/home_icons/cz.png')}
                                            buttonTitle={'充值'} tag={'cz'}
                                            onClick={this._onMenuClick}/>
                                <MenuButton buttonIcon={require('../images/home_icons/dyp.png')}
                                            buttonTitle={'电影票'} tag={'dyp'}
                                            onClick={this._onMenuClick}/>
                            </View>
                            <View style={styles.menuView}>
                                <MenuButton buttonIcon={require('../images/home_icons/yxcz.png')}
                                            buttonTitle={'游戏充值'} tag={'yxcz'}
                                            onClick={this._onMenuClick}/>
                                <MenuButton buttonIcon={require('../images/home_icons/xjk.png')}
                                            buttonTitle={'小金库'} tag={'xjk'}
                                            onClick={this._onMenuClick}/>
                                <MenuButton buttonIcon={require('../images/home_icons/ljd.png')}
                                            buttonTitle={'领京豆'} tag={'ljd'}
                                            onClick={this._onMenuClick}/>
                                <MenuButton buttonIcon={require('../images/home_icons/gd.png')}
                                            buttonTitle={'更多'} tag={'gd'}
                                            onClick={this._onMenuClick}/>
                            </View>
